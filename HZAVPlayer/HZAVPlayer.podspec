#
#  Be sure to run `pod spec lint WZRouter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/lanhaiyang/HZAVPlayer.git"
  ...
  spec.subspec 'Classes' do |p|
    p.source_files = "HZAVPlayer/HZAVPlayer/HZAVPlayer/**/*.{h,m}"
  end
...
#  spec.resources = 'HZAVPlayer/HZAVPlayer/Resources/*.{bundle}'
